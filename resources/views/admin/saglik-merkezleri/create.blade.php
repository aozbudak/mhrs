...
@section('subtitle', 'Sağlık merkezi bilgileri, çalışma saatleri ve isteğe bağlı doktor hesapları')
        ...
        <form method="post" action="{{ route('admin.saglik-merkezleri.store') }}" class="rounded-3xl border border-sky-100/80 bg-white/70 hospital-glass p-5 shadow-sm space-y-6">
            ...
            <div class="border-t border-sky-100 pt-6">
                ...
                <p class="mt-1 text-xs text-slate-600 leading-relaxed">
                    Bu kurumda görevli tüm doktorlar için randevu slotları bu aralıklara göre üretilir (30 dakikalık dilimler).
