...
@section('content')
    ...
    <div class="grid gap-4 lg:grid-cols-2 lg:items-start">
                ...
                <div class="mt-4 space-y-3">
                    ...
                    @else
                        @foreach ($yaklasanRandevularGizli as $r)
                            ...
                            @include('musteri.partials.randevu-kart', [
                                'r' => $r,
                                'durumEtiket' => $yEtiketG,
                                'cardClass' => 'rounded-2xl border border-violet-200/90 bg-white/70 p-4',
                                'titleClass' => 'text-sm font-semibold text-violet-950',
                                'subClass' => 'mt-1 text-xs text-violet-900/80',
                                'showIptal' => true,
                                'gizliRozet' => true,
                                'haritaModu' => 'full',
                            ])
        ...
        <section class="rounded-3xl border border-sky-100/80 bg-white/70 hospital-glass p-5 shadow-sm lg:max-w-xl lg:justify-self-end w-full">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
            ...
            <div class="mt-4 space-y-2">
                @forelse ($sonRandevular as $r)
                    ...
                    @include('musteri.partials.randevu-kart', [
                        ...
                        'cardClass' => 'rounded-2xl border border-sky-100 bg-white/60 px-3 py-2.5',
                        'haritaModu' => 'link',
                        'kurumDetay' => false,
                        'gizliRozet' => (bool) $r->gizli,
                    ])
                @empty
